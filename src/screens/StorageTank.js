  ...
  return (
    <View style={styles.container}>
      <View style={{borderRadius: 20, width: '100%', height: '8%', justifyContent: 'center', alignItems: 'center'}}>
        <Text style={styles.tankTitle}>Storage Tank</Text>
      </View>
      <ViewPager style={{width: '100%', height: '100%'}} ref={pagerRef}>
          ...
          <View style={styles.waterLevelLayout}>
            ...
            <TouchableOpacity 
              ...
              <View>
                ...
                <Text style={styles.statusTankDescription}>{'The system will do another\nround of treatment.'}</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
        <View style={{flex: 1}} key="2">
          <ScrollView>
            <View style={{backgroundColor: 'rgba(196,196,196, 0.2)', width: '84%', height: 160, marginHorizontal: '8%', borderRadius: 20, marginTop: '4%'}}>
              <Text style={{marginLeft: '8%', marginTop: '6%', fontFamily: 'Inter', fontSize:25, fontWeight: '700', color:'#89969F' }}>pH</Text>
              <View style={{flexDirection: 'row', width: '84%', marginHorizontal: '8%', marginTop: 16, justifyContent: 'space-between', alignItems: 'center'}}>
                <HealthBar />
                <Text style={{fontFamily: 'Inter', fontWeight: '700', color: '#606263', fontSize: 40}}>
                  5.5
                </Text>
              </View>
            </View>
